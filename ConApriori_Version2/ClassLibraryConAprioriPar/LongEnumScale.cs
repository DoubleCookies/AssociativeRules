...

{
    ...
    public class LongEnumScale
    {
        ...
        public string item_enum;   //свойства объекта- внешнее представление
        ...
        /// <summary>
        /// содержит ли список наборов текущий набор
        /// </summary>
        /// <param name="rset">множество наборов</param>
        ...
        /// <summary>
        /// является ли текущий набор подмножеством 
        /// одного из элементов списка наборов 
        /// </summary>
        /// <param name="rset">множество наборов</param>
        /// <returns>true, если текущий набор подмножество элемента списка</returns>
        public bool IsSubset(List<LongEnumScale> rset)
        {

            foreach (LongEnumScale item in rset)
                if (this.Equal_Arrs(this & item, this.dig_enum))
                    return true;
            return false;  
        }
    }
