...
namespace WindowsFormsConAprioriLong
{
    public partial class FormWorkingWithRules : Form
    {
        ...
        ClassLibraryConAprioriLong.Rule rule;
        ...
        private void buttonCreateRule_Click(object sender, EventArgs e)
        {
            ...
            double sup = rules.Support(set);
            double sup1 = rules.Support(pre_prop), sup2 = rules.Support(con_prop);
            rule = new ClassLibraryConAprioriLong.Rule(pre_prop, con_prop);
            rule.Support = sup;
